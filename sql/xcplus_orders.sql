...
INSERT INTO `mq_message_history` (`id`, `message_type`, `business_key1`, `business_key2`, `business_key3`,
                                  ...
                                  `stage_state4`)
VALUES (1, 'payresult_notify', '16', '60201', NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0'),
       (15, 'payresult_notify', '11', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0'),
       (16, 'payresult_notify', '15', '60201', NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0');
/*!40000 ALTER TABLE `mq_message_history`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
LOCK
    TABLES `xc_orders` WRITE;
/*!40000 ALTER TABLE `xc_orders`
    DISABLE KEYS */;
INSERT INTO `xc_orders` (`id`, `total_price`, `create_date`, `status`, `user_id`, `order_type`, `order_name`,
                         `order_descrip`, `order_detail`, `out_business_id`)
VALUES (1577177773194113024, 1.00, '2022-10-04 14:04:18', '600002', '50', '60201', '测试课程01', '购买课程:测试课程01',
        '[{\"goodsId\":2,\"goodsType\":\"60201\",\"goodsName\":\"测试课程01\",\"goodsPrice\":1}]', '10'),
       (1577258681653280768, 1.00, '2022-10-04 19:25:48', '600002', '52', '60201', 'Nacos微服务开发实战',
        '购买课程:Nacos微服务开发实战',
        '[{\"goodsId\":117,\"goodsType\":\"60201\",\"goodsName\":\"Nacos微服务开发实战\",\"goodsPrice\":1}]', '11'),
       (1585094781512269824, 11.00, '2022-10-26 10:23:40', '600002', '51', '60201', 'java零基础入门',
        '购买课程:java零基础入门',
        '[{\"goodsId\":18,\"goodsType\":\"60201\",\"goodsName\":\"java零基础入门\",\"goodsPrice\":11}]', '15'),
       (1623527995495899136, 1.00, '2023-02-09 11:43:32', '600002', '52', '60201', 'Spring Cloud 开发实战',
        '购买课程:Spring Cloud 开发实战',
        '[{\"goodsId\":121,\"goodsType\":\"60201\",\"goodsName\":\"Spring Cloud 开发实战\",\"goodsPrice\":1}]', '16');
/*!40000 ALTER TABLE `xc_orders`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
LOCK
    TABLES `xc_orders_goods` WRITE;
/*!40000 ALTER TABLE `xc_orders_goods`
    DISABLE KEYS */;
INSERT INTO `xc_orders_goods` (`id`, `order_id`, `goods_id`, `goods_type`, `goods_name`, `goods_price`, `goods_detail`)
VALUES (2, 1577177773194113024, '2', '60201', '测试课程01', 1.00, NULL),
       (3, 1577258681653280768, '117', '60201', 'Nacos微服务开发实战', 1.00, NULL),
       (4, 1585094781512269824, '18', '60201', 'java零基础入门', 11.00, NULL),
       (5, 1623527995495899136, '121', '60201', 'Spring Cloud 开发实战', 1.00, NULL);
/*!40000 ALTER TABLE `xc_orders_goods`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
(
  ...
  AUTO_INCREMENT = 1623527995601891330
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK
    TABLES `xc_pay_record` WRITE;
/*!40000 ALTER TABLE `xc_pay_record`
    DISABLE KEYS */;
INSERT INTO `xc_pay_record` (`id`, `pay_no`, `out_pay_no`, `out_pay_channel`, `order_id`, `order_name`, `total_price`,
                             `currency`, `create_date`, `status`, `pay_success_time`, `user_id`)
VALUES (1577177773231415298, 1577177773231861760, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 14:04:18', '601001', NULL, '50'),
       (1577179016003612674, 1577179015973519360, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 14:09:15', '601001', NULL, '50'),
       (1577181370643955713, 1577181370624544768, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 14:18:36', '601001', NULL, '50'),
       (1577182027190972417, 1577182027171524608, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 14:21:13', '601001', NULL, '50'),
       (1577182653388025858, 1577182653344460800, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 14:23:42', '601001', NULL, '50'),
       (1577237009017651202, 1577237008990695424, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 17:59:41', '601001', NULL, '50'),
       (1577239361250500609, 1577239361225244672, NULL, NULL, 1577177773194113024, '测试课程01', 1.00, 'CNY',
        '2022-10-04 18:09:02', '601002', '2022-10-04 18:09:44', '50'),
       (1577419635984793601, 1577419635962195968, '2022100522001422760505741092', 'Alipay', 1577258681653280768,
        'Nacos微服务开发实战', 1.00, 'CNY', '2022-10-05 06:05:23', '601002', '2022-10-05 06:06:39', '52'),
       (1585094781699452930, 1585094781684236288, NULL, NULL, 1585094781512269824, 'java零基础入门', 11.00, 'CNY',
        '2022-10-26 10:23:40', '601001', NULL, '51'),
       (1585096384011689985, 1585096383987376128, '2022102622001422760505751569', '603002', 1585094781512269824,
        'java零基础入门', 11.00, 'CNY', '2022-10-26 10:30:02', '601002', '2022-10-26 10:32:13', '51'),
       (1585118358242865154, 1585118358214623232, '2022102622001422760505751132', '603002', 1585094781512269824,
        'java零基础入门', 11.00, 'CNY', '2022-10-26 11:57:21', '601002', '2022-10-26 11:58:50', '51'),
       (1623527995601891329, 1623527995592368128, '2023020922001422760505798854', '603002', 1623527995495899136,
        'Spring Cloud 开发实战', 1.00, 'CNY', '2023-02-09 11:43:32', '601002', '2023-02-09 11:44:42', '52');
/*!40000 ALTER TABLE `xc_pay_record`
    ENABLE KEYS */;
UNLOCK
    TABLES;
