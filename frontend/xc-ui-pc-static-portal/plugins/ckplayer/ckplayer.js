		...
		*/
        getVideo: function () {
            ...
            if (this.html5Video) { //如果支持HTML5-VIDEO则默认使用HTML5-VIDEO播放器
                ...
                if (this.VA.length == 1) {
                    /**
                     * 注释decodeURIComponent
                     * 如果不这样做，Signature带'+'号的视频地址会出现403错误，下面是个错误地址例子
                     * https://outin-5e09cdea183711eaa17d00163e1c60dc.oss-cn-beijing.aliyuncs.com/sv/117643a3-17765f29da5/117643a3-17765f29da5.mp4?Expires=1615964967&OSSAccessKeyId=LTAI3DkxtsbUyNYV&Signature=nIzVj%2BtKdqH42dmyTfWgBCuohIY%3D
                     */
                    // this.videoTemp['src'] = decodeURIComponent(this.VA[0][0]);
                    this.videoTemp['src'] = this.VA[0][0];
